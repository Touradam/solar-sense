...
export function PresetManager({ currentConfig, onLoadPreset }: PresetManagerProps) {
  ...
  /**
   * Handle loading the selected preset
   */
  const handleLoadPreset = () => {
    if (selectedPreset) {
      onLoadPreset(selectedPreset.config);
    }
  };
      ...
      <div className="space-y-4">
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
          >
        ...
        {selectedPreset && (
          <div className="p-4 rounded-xl border-2 border-emerald-500 dark:border-emerald-400 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-950/20 dark:to-green-950/20">
            ...
            <div className="space-y-2 mb-4">
              ...
              {/* Advanced Features */}
              {(() => {
                const features = getEnabledFeatures(selectedPreset.config);
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {features.map((feature) => (
                          <span
                            key={feature}
                            className="text-xs px-2 py-1 rounded bg-emerald-600 dark:bg-emerald-500 text-white font-medium"
                          >
                            {feature}
                          </span>
                        ))}
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-lg bg-gradient-to-r from-emerald-600 to-green-600 text-white font-medium hover:from-emerald-700 hover:to-green-700 transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
            >
        ...
        {!showSaveDialog && (
          <button
            ...
            className="w-full py-2.5 px-4 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-medium hover:border-purple-500 hover:text-purple-600 dark:hover:text-purple-400 transition-all flex items-center justify-center gap-2"
          >
